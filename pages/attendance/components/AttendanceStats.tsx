...
const AttendanceStats: React.FC<AttendanceStatsProps> = ({ stats }) => {
    ...
    const totalEmployees = stats.present + stats.late + stats.absent + stats.onLeave + stats.onMission;
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8">
            ...
            <StatsCard icon="fas fa-tasks" labelKey="attendanceStats.onMission" value={String(stats.onMission)} change={t('attendanceStats.onMissionDesc')} changeColor="text-cyan-600" iconBgColor="bg-cyan-100" iconColor="text-cyan-600" />
