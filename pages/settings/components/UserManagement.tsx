                    ...
                    {availableUsers.map(user => (
                        <div key={user.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-3">
                            <div className="flex items-center">
                                <img className="h-10 w-10 rounded-full me-4" src={user.avatar} alt={user.name} />
                                <div>
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm border-t pt-2">
                                <div><p className="text-xs text-gray-500">الدور</p><p className="font-medium text-gray-800">{user.role}</p></div>
                                <div>
